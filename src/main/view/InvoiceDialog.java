...
public class InvoiceDialog extends JDialog {
    ...
    public InvoiceDialog(JFrame parent) {
        ...
        // Tiêu đề lớn
        JLabel titleLabel = new JLabel("COFFEE ILLUSTRATION");
        ...
        totalValueLabel.setFont(new Font("SansSerif", Font.BOLD, 14));
        ...
        thanksLabel.setFont(new Font("SansSerif", Font.ITALIC, 14));
